          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto text-pretty leading-relaxed">
                We are an AI Agent Laboratory dedicated to crafting elegant, accessible artificial intelligence
                solutions that serve more users worldwide. Our mission is to democratize AI through innovation,
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-slate-600 text-pretty">
                      We believe that powerful technology should be elegant and intuitive, making complex AI accessible
                      to everyone.
                    </p>
                  </CardContent>
                </Card>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-slate-600 mb-8 text-pretty">
                    At our AI Agent Laboratory, we focus on creating compact, efficient AI solutions that deliver
                    maximum impact. Our approach combines cutting-edge machine learning with user-centered design
                    principles.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-pretty">
                          Continuously exploring the latest developments in artificial intelligence to create more
                          capable and efficient agents.
                        </p>
                      </div>
                    </div>
